...
import { ADD_SUPER_ADMIN_ROUTE, EDIT_SUPER_ADMIN_ROUTE, LOGIN_ROUTE } from '../../constants/index';
import {
  deepOrange,
  deepPurple,
  red,
...
import { deleteSuperAdmin, getSuperdmins } from '../../Redux/SuperAdmins/Actions';
    ...
    <div>
      ...
      {admin.admin.email === undefined && !admin.loading ? history.push(LOGIN_ROUTE) :
        ...
        <div >
                  ...
                  <TableRow
                    ...
                    <TableCell align="left" size='small'>
                      <Link
                        ...
                        to={EDIT_SUPER_ADMIN_ROUTE + '?' + item._id}>
                        <IconButton
                          className={classes.button}>
          ...
          <Link style={{ color: 'inherit', textDecoration: 'inherit' }} to={ADD_SUPER_ADMIN_ROUTE}>
          ...
          >
            ...
            <DialogActions>
              ...
              <Button
                onClick={() => {
                  dispatch(deleteSuperAdmin(ItemIdDelete));
